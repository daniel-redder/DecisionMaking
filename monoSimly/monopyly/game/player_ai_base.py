...
class PlayerAIBase(object):
    ...
    async def money_will_be_taken(self, player, amount):
        '''
    ...
    async def money_given(self, player, amount):
        '''
    ...
    async def got_get_out_of_jail_free_card(self):
        '''
    ...
    async def pay_ten_pounds_or_take_a_chance(self, game_state, player):
        '''
    ...
    async def property_offered_for_auction(self, game_state, player, property):
        '''
    ...
    async def auction_result(self, status, property, player, amount_paid):
        '''
    ...
    async def sell_houses(self, game_state, player):
        '''
    ...
    async def deal_result(self, deal_info):
        '''
    ...
    async def deal_completed(self, deal_result):
        '''
    ...
    async def player_went_bankrupt(self, player):
        '''
    ...
    async def player_ran_out_of_time(self, player):
        '''
    ...
    async def game_over(self, winner, maximum_rounds_played):
        '''
    ...
    async def ai_error(self, message):
        '''
    ...
    async def eminent_domain(self, game_state, player):
        '''
