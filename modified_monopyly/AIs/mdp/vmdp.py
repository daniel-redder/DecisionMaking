...
class vmdp():
    ...
    def build_deal_matrices(self,n_states,game_state):
        ...
        decline_deal_state = copy.deepcopy(stateSpace)

        self.deal_stateSpace = stateSpace

        accept_deal_state = copy.deepcopy(stateSpace)
        ...
        for action in range(action_dimensions):
            if action == 0:
                for state in range(len(stateSpace)):
                            ...
                            decline_deal_state[state][pos] = 0
        ...
        self.decline_deal_state = decline_deal_state
        self.accept_deal_state = accept_deal_state
